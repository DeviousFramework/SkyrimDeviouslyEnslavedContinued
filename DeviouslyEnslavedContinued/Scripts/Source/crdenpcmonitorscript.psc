...
; * Moving to a shared lib is not advisable as calling another script allows for context
; * switching, making it less efficient.  Since logging is done frequently it should be defined
; * in the local script.
